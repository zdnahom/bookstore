...
>An app that adds your favorite book to your collection which is built using React
...
git clone git@github.com:zdnahom/bookstore.git
...
No test module for now.But it will be added in the near future.
